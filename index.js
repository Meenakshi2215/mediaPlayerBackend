...
//create path to db.json file using .router() as an argument
...
//connect or use middleware and router in server

mediaPlayerServer.use(middleware)
mediaPlayerServer.use(router)

// setup port for the server (bydefault aayitt react and json is run in 3000 port)
